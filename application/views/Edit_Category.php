                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="smart-forms smart-container wrap">
                                ...
                                <?= form_open('updatecategory', 'class="" role=""'); ?>
                                <div class="form-body">

                                    <div class="spacer-b30">
                                        <div class="tagline"><span>Edit Category</span></div>
                                    </div>

                                    <?php foreach ($categoryId as $catId): ?>
                                    <div class="section">
                                        <label style="color: #16A4FA; font-weight: bold">Category Title</label>
                                        <label class="field prepend-icon">
                                            <input value="<?php echo strtoupper($catId->category_name); ?>" name="categoryTitle" id="catgeoryTitle" class="gui-input" placeholder="Category Title" type="text" required="">
                                            <input type="hidden" value="<?php echo $catId->id_category; ?>" name="id">
                                    ...
                                    <div class="section">
                                        ...
                                        <label class="field select">
                                            <select name="categoryStatus" id="categoryStatus">
                                                <option <?php if($catId->category_status == 1) { echo 'selected'; }?> value="1">Active</option>
                                                <option <?php if($catId->category_status == 2) { echo 'selected'; }?> value="2">Inactive</option>
                                            </select>
                                            <i class="arrow"></i>
                                        </label>
                                    </div>
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="button btn-primary"><i class="fa fa-gamepad"></i> Update Category </button>
                                </div>
                                <?= form_close(); ?>
                            </div>
