                                                ...
                                                <li class="is-visible">
                                                    ...
                                                    <div class="game-shadow">
                                                        ...
                                                        <div class="game-stats">
                                                            ...
                                                            <a href="<?php echo base_url().'index.php/promogame?id=' . $game->id_game.'&promo=add'; ?>" style="text-decoration: none;margin-left:5px;" class="category">
                                                                <i class="fa fa-clone" aria-hidden="true" style="margin-right:3px;"></i> MAKE PROMO
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <!-- Game Cover -->
