                                                ...
                                                <li class="is-visible">
                                                    ...
                                                    <div class="game-shadow">
                                                        ...
                                                        <div class="game-stats">
                                                            <a href="<?php echo base_url().'index.php/changestatusgame?id=' . $game->id_game . '&status=' . $game->game_status; ?>" class="category" style="background-color:red;">
                                                                <i class="fa fa-pencil" aria-hidden="true" style="margin-right:5px;"></i>Inactive
                                                            </a>
                                                            <a href="<?php echo base_url().'index.php/promogame?id=' . $game->id_game.'&promo=delete'; ?>" style="text-decoration: none;margin-left:5px;" class="category">
                                                                <i class="fa fa-clone" aria-hidden="true" style="margin-right:3px;"></i> DEL PROMO
                                                            </a>
                                                        </div>
                                                    </div>
                                                    <!-- Game Cover -->
